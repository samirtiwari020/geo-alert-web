    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <CardContent>
                <div className="relative bg-secondary/20 rounded-lg h-96 overflow-hidden">
                  ...
                  {zones.map((zone) => (
                    <div
                      key={zone.id}
                      className={`absolute w-6 h-6 rounded-full border-2 border-white cursor-pointer transform -translate-x-3 -translate-y-3 ${getRiskColor(zone.risk)} hover:scale-125 transition-transform`}
                ...
                <Tabs defaultValue="dem" className="w-full">
                  ...
                  <TabsContent value="dem" className="mt-4">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Digital Elevation Model data provides high-resolution topographic information for slope stability analysis.
                      </p>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="drone" className="mt-4">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Real-time aerial imagery and thermal data from autonomous drone fleet monitoring all zones continuously.
                      </p>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="sensors" className="mt-4">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        IoT sensor network monitoring vibrations, soil moisture, temperature, and structural integrity across all zones.
                      </p>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="weather" className="mt-4">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Comprehensive weather monitoring including precipitation, wind patterns, and atmospheric conditions affecting stability.
                      </p>
                    </div>
                  </TabsContent>
                </Tabs>
          ...
          {/* Alert Panel and Prediction Form */}
            ...
            <Card className="bg-card border-border">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Synthetic Data Prediction</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-4">
